package com.aa.common.controllers;
...
public class CommonController<RQ,RS, S extends CrudService<RQ,RS>> {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RS> actualizar(@PathVariable @Positive(message = "El id debe ser positivo") Long id,@Valid @RequestBody RQ request){
