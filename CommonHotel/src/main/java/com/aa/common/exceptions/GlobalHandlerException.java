package com.aa.common.exceptions;


import com.aa.common.dto.CustomErrorResponse;
...
public class GlobalHandlerException {
    ...
    public ResponseEntity<CustomErrorResponse> HandleIllegalArgumentException(IllegalArgumentException e){
        log.error("Error de la peticion {}",e.getMessage());
        return ResponseEntity.badRequest().body(new CustomErrorResponse(HttpStatus.BAD_REQUEST.value(),e.getMessage()));
    }
    ...
    public ResponseEntity<CustomErrorResponse> handleJsonParse(HttpMessageNotReadableException e) {
        log.error("Error interno del servidor: {}", e.getMostSpecificCause().getMessage(), e);
